      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="row">
            <div class="col-lg-5 col-md-5 mb-xs-30">
              <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native"> <a href="#"><img src="{{url('/')}}/public/assets/images/1.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/2.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/3.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/6.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="{{url('/')}}/public/assets/images/6.jpg" alt="Stylexpo"></a> </div>
            </div>
                      ...
                      <div class="share-link">
                        ...
                        <div class="social-link">
                          <ul class="social-icon">
                            <li><a class="facebook" title="Facebook" href="https://www.facebook.com/sharer/sharer.php?u=https%3A//www.facebook.com/RovannaMakeup/"><i class="fa fa-facebook"> </i></a></li>
                            <li><a class="twitter" title="Twitter" href="https://twitter.com/home?status=https%3A//twitter.com/rovanna_makeup"><i class="fa fa-twitter"> </i></a></li>
                            <li><a class="instagram" title="instagram" href="https://www.instagram.com/rovanna_makeup/"><i class="fa fa-instagram"> </i></a></li>
                            </ul>
                        </div>
                      </div>
                    </div>
        ...
        <div class="col-lg-3">
          <div class="brand-logo-pro align-center mb-30">
            <img src="{{url('/')}}/public/assets/images/brand5.png" alt="Stylexpo">
          </div>
          <div class="sub-banner-block align-center">
            <img src="{{url('/')}}/public/assets/images/pro-banner.jpg" alt="Stylexpo">
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="items-Reviews">
                      <div class="comments-area">
                        ...
                        <ul class="comment-list mt-30">
                          <li>
                            <div class="comment-user"> <img src="{{url('/')}}/public/assets/images/comment-user.jpg" alt="Stylexpo"> </div>
            ...
            <div class="owl-carousel pro-cat-slider">
              <div class="item">
                <div class="product-item">
                  ...
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/10.jpg" alt="Stylexpo"> </a>
              ...
              <div class="item">
                <div class="product-item">
                  ...
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/13.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label new-label"><span>New</span></div>
                  <div class="main-label sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/4.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/5.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/6.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/8.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label new-label"><span>New</span></div>
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/9.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/11.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label new-label"><span>New</span></div>
                  <div class="main-label sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="{{route('product_page')}}"> <img src="{{url('/')}}/public/assets/images/2.jpg" alt="Stylexpo"> </a>
                  <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
