          ...
          <div class="account-sidebar account-tab mb-xs-30">
            ...
            <div class="account-tab-inner">
              <ul class="account-tab-stap">
                ...
                <li id="step2" class=""> <a href="javascript:void(0)">Account Details<i class="fa fa-angle-right"></i> </a> </li>
                <li id="step3" class=""> <a href="javascript:void(0)">My Order List<i class="fa fa-angle-right"></i> </a> </li>
                <li id="step4" class=""> <a href="javascript:void(0)">Change Password<i class="fa fa-angle-right"></i> </a> </li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="mb-20">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="input-box select-dropdown">
                        <fieldset>
                          <select name="shippingCountryId" class="option-drop" id="shippingcountryid" style="display: none;">
                          ...
                          </select><span class="ui-selectmenu-button ui-widget ui-state-default ui-corner-all" tabindex="0" id="shippingcountryid-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="shippingcountryid-menu" aria-haspopup="true" style="width: 100px;"><span class="ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">Select Country</span></span>
                        </fieldset>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="input-box select-dropdown">
                        <fieldset>
                          <select name="shippingstateId" class="option-drop" id="shippingstateid" style="display: none;">
                          ...
                          </select><span class="ui-selectmenu-button ui-widget ui-state-default ui-corner-all" tabindex="0" id="shippingstateid-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="shippingstateid-menu" aria-haspopup="true" style="width: 100px;"><span class="ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">Select a State</span></span>
                        </fieldset>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="input-box select-dropdown">
                        <fieldset>
                          <select name="billingcountryId" class="option-drop" id="billingcountryid" style="display: none;">
                            <option selected="" value="">Select Country</option>
                            <option value="AX">Aland Islands</option>
                            <option value="AF">Afghanistan</option>
                            <option value="AL">Albania</option>
                            ...
                            <option value="ZM">Zambia</option>
                            <option value="ZW">Zimbabwe</option>
                          </select><span class="ui-selectmenu-button ui-widget ui-state-default ui-corner-all" tabindex="0" id="billingcountryid-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="billingcountryid-menu" aria-haspopup="true" style="width: 100px;"><span class="ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">Select Country</span></span>
                        </fieldset>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="input-box select-dropdown">
                        <fieldset>
                          <select name="billingstateId" class="option-drop" id="billingstateid" style="display: none;">
                            <option value="">Select a State</option>
                            <option value="AP">Andhra Pradesh</option>
                            <option value="AR">Arunachal Pradesh</option>
                            <option value="AS">Assam</option>
                            ...
                            <option value="LD">Lakshadeep</option>
                            <option value="PY">Pondicherry (Puducherry)</option>
                          </select><span class="ui-selectmenu-button ui-widget ui-state-default ui-corner-all" tabindex="0" id="billingstateid-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="billingstateid-menu" aria-haspopup="true" style="width: 100px;"><span class="ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">Select a State</span></span>
                        </fieldset>
                      </div>
                    </div>
                    <div class="col-md-6">
